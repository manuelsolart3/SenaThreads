...
public class PostTweetCommandHandler : ICommandHandler<PostTweetCommand, Result>
{
    ...
    public async Task<Result<Result>> Handle(PostTweetCommand request, CancellationToken cancellationToken)
    {
